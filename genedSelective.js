...
module.exports = function(socket,doc,pdfConfig,mode){
	switch(mode){
		case 'coverpage':
			...
			doc.font('Times-Roman').fontSize(50).text('Mock Selective Exam',60,380,{
				width : 500,
			})
		...
		case 'pre end':
			...
			doc.fontSize(10).text('First name: ________________  Family name: _________________  Date: ____________  Class: ____________',50,140,{align:'left'})
